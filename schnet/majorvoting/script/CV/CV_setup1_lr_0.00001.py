...
wandb.init(
    ...
    name= "CV setup 1 with batchsize 1, early stopping and exp learning schedule", #实验的名字
...
# put model to GPU
model = SchNetModel(hidden_channels=512, out_dim=6, max_len=max_len).to(device)
...
torch.save(model.state_dict(), '/work3/s194408/Project/result/CV_setup1_lr0.00001.pth')

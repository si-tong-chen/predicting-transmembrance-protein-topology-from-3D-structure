...
wandb.init(
    ...
    name= "CV setup 1 with batchsize 1, 6 layers, 32 neigbors, reduced Gaussian kernel", #实验的名字
...
torch.save(model.state_dict(), '/work3/s194408/Project/result/schnet/CV_setup1_neighbors_Gauss_big_kernel_setup1.pth')
...
np.savetxt("/work3/s194408/Project/result/schnet/CVsetup1_node_acc_results_Gauss_big_kernel_setup1.csv", node_acc_results, delimiter=',', comments="", fmt='%s')

loss_results = np.concatenate([ [np.array(epochs)], [np.array(epoch_loss_record_train)], [np.array(epoch_loss_record_val)] ])
np.savetxt("/work3/s194408/Project/result/schnet/CVsetup1_loss_results_Gauss_big_kernel_setup1.csv", loss_results, delimiter=',', comments="", fmt='%s')

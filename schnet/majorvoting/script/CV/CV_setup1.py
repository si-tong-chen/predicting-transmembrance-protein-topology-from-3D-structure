...
torch.save(model.state_dict(), '/work3/s194408/Project/result/CV_setup1_5_neighbors.pth')
...
np.savetxt("/work3/s194408/Project/result/schnet/CVsetup1_node_acc_results.csv", node_acc_results, delimiter=',', comments="", fmt='%s')

loss_results = np.concatenate([ [np.array(epochs)], [np.array(epoch_loss_record_train)], [np.array(epoch_loss_record_val)] ])
np.savetxt("/work3/s194408/Project/result/schnet/CVsetup1_loss_results.csv", loss_results, delimiter=',', comments="", fmt='%s')
